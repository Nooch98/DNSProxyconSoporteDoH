...
from socketserver import ThreadingUDPServerfrom tracemalloc import start
import requests
import socketserver
import logging
import time
...
def run_test():
    log("Verificando la configuración del servidor DNS...", "INFO")
